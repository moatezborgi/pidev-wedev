 ...
 */
final class Version20220218221539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, type_reclamation_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, count INT NOT NULL, remboursement TINYINT(1) NOT NULL, INDEX IDX_CE6064047BA88B4D (type_reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
