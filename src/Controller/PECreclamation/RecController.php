...
namespace App\Controller\PECreclamation;
...
class RecController extends AbstractController
{
    ...
    /**
     * @Route("/new/{login}", name="rec_new", methods={"GET", "POST"})
     */
    public function new(Request $request, EntityManagerInterface $entityManager,$login): Response
    {
        $reclamation = new Reclamation($login);
