 ...
 * @author Rania
 */
public class ajouterresto extends SideMenuBaseForm {
     public ajouterresto(Resources res) {
        super(BoxLayout.y());
        ...
        add(new Label("Today", "TodayTitle"));
          TextField reference = new TextField("", "Reference restaurant", 20, TextField.TEXT_CURSOR) ;
          TextField nom = new TextField("", "Nom restaurant", 20, TextField.TEXT_CURSOR) ;
          TextField telephone = new TextField("", "telephone", 20, TextField.TEXT_CURSOR) ;
          TextField adresse = new TextField("", "Adresse", 20, TextField.TEXT_CURSOR) ;
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        if( Servicerestaurant.getInstance().addresto(t))
                        {
