 ...
 * @author Rania
 */
public class ajoutmenu extends SideMenuBaseForm{
     public ajoutmenu(Resources res, String id) {
        super(BoxLayout.y());
        ...
        add(new Label("Today", "TodayTitle"));
          ...
          TextField lib_plat = new TextField("", "Lib plat", 20, TextField.TEXT_CURSOR) ;
          TextField prix_plat = new TextField("", "pix", 20, TextField.TEXT_CURSOR) ;
          TextField nom_plat = new TextField("", "Nom_plat", 20, TextField.TEXT_CURSOR) ;
        ...
        FontImage arrowDown = FontImage.createMaterial(FontImage.MATERIAL_KEYBOARD_ARROW_DOWN, "Label", 3);
          btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((lib_plat.getText().length()==0)||(nom_plat.getText().length()==0))
                    Dialog.show("Alert", "tous les champs sont obligatoire", new Command("OK"));
                else
                {
                    try {
                        Menu t = new Menu( lib_plat.getText().toString(), ((int)Float.parseFloat(prix_plat.getText().toString())),nom_plat.getText().toString());
                        if( Servicemenu.getInstance().addmenu(t,id))
                        {
