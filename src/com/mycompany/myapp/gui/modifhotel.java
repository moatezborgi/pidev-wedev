 ...
 * @author MSI
 */
public class modifhotel extends SideMenuBaseForm {
    
     public modifhotel(Resources res,String idhotel,String nomhotel,String villehotel,int nbetoilehotel) {
        super(BoxLayout.y());
        ...
        add(new Label("Today", "TodayTitle"));
          TextField reference = new TextField(idhotel, "Reference", 20, TextField.TEXT_CURSOR) ;
     TextField nom = new TextField(nomhotel, "Nom hotel", 20, TextField.TEXT_CURSOR) ;
          TextField ville = new TextField(villehotel, "Ville hotel", 20, TextField.TEXT_CURSOR) ;
          TextField nbetoile = new TextField(nbetoilehotel+"", "N°etoile", 20, TextField.NUMERIC) ;
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                else
                {
                    try {
                        ...
                        if( Servicehotel.getInstance().modifehotel(t))
                        {
