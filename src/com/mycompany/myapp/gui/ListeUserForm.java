...
public class ListeUserForm extends BaseForm{
    ...
    Form current;
    public ListeUserForm(Resources res ) {
  ...
  //      System.out.println("user connecté password ="+ SessionManager.getPassowrd());
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes Utilisateurs", barGroup);
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          ListeUserForm a = new ListeUserForm(res);
           a.show();
            refreshTheme();
        });
        ...
        ArrayList<Users>list = ServiceUsers.getInstance().getallusers();
    ...
    private void addButton(Image img, Users u, Resources res) {
        ...
        Label objetTxt = new Label("nom : "+u.getNom(),"NewsTopLine2");
        Label dateTxt = new Label("prenom : "+u.getPrenom(),"NewsTopLine2");
        Label etatTxt = new Label("email : "+u.getEmail(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce user ?","Annuler","Oui")) {
                ...
                if(ServiceUsers.getInstance().deleteUser(u.getId())) {
